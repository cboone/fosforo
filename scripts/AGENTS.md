...
- Installation helpers build exactly what they install and report the bundle hash/provenance. Follow [host verification](../docs/notes/host-verification.md); the shared plugin folders and host streams are exclusive.
