...
- For shader bindings or backend work, read [shader plumbing](../docs/notes/shader-plumbing.md). Keep binding indices and shared structures consistent between Zig and Metal, including reload validation.
