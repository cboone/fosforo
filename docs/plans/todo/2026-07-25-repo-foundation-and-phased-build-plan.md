...
| [#38](https://github.com/cboone/fosforo/issues/38) | 4    | The trace itself: a line strip in `shaders/scope.metal`, drawn over the existing clear. **Settled the vertical axis as [ADR 0016](../../adr/0016-absolute-vertical-axis.md):** fixed and absolute, with over-scale railed rather than rescaled or clipped away                                                                                                                                                        |
