...
- When changing a measured value, search its old value across the repository, including source/code, docs, ADRs, comments and workflows, respecting the completed-plan exception.
