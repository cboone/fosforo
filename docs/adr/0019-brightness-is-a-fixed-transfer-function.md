...
>
> **A white core on moving material is therefore a property of a *triggered* display.** `white_headroom` stays at **0.8** on the derivation, and the re-judgement moves to phase 4, where the sweep stops wandering and periodic content can dwell. It is no longer waiting on anything in phase 3.
