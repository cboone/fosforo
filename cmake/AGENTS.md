...
- Zig authors the CLAP; CMake invokes Zig's `impl` target for the implementation archive and integrates clap-wrapper for the plugin formats. Preserve permanent CLAP and Audio Unit identity and the separate display-name rules.
